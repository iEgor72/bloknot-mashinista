...
<!-- AUTO_STATUS:START -->
Generated: 2026-06-01 11:20:24 +1000
...
- HEAD: `a2c99e8`
- Last commit: `a2c99e8 fix(poekhali): ops editor sheet was invisible (rendered inside hidden shell)`
...
* poekhali-rework      a2c99e8 fix(poekhali): ops editor sheet was invisible (rendered inside hidden shell)
```

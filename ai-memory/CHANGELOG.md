...
## 2026-05-05 11:25:40 +0000

- Source: `manual`
- Task: Выделил активный участок скорости в Поехали
- Branch: `main`
- Methods: `активное ограничение рисуется толще/ярче с glow и pill-лейблом`, `остальные скоростные полосы приглушены`, `подписи скоростей приведены к единому виду 'N км/ч'`, `активный лейбл показывает сколько тянуть составом до выхода из участка`, `cache bump`
- Files: `scripts/poekhali-tracker.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-05 11:31:45 +0000

- Source: `manual`
- Task: Исправил направление объектов/сигналов Поехали
- Branch: `main`
- Methods: `direction by coordinate delta inverted to match route reality: coordinate growth = ЧЕТ (Постышево→Комсомольск)`, `coordinate decrease = НЕЧЕТ (Комсомольск→Постышево)`, `object file fallback mapped per actual APK signal files`, `cache bump`
- Files: `scripts/poekhali-tracker.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-05 11:36:41 +0000

- Source: `manual`
- Task: Починил ручной ввод ПР и убрал оставшийся пунктир курсора
- Branch: `main`
- Methods: `убрал preview cursor dash между профилем и км-шкалой`, `добавил draft-состояние формы предупреждений`, `чтобы км/пк/участок/скорость/дата не сбрасывались при rerender/save`, `bulk textarea сохраняет черновик при rerender`, `cache bump`
- Files: `scripts/poekhali-tracker.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-05 11:55:07 +0000

- Source: `manual`
- Task: Расширил слой режимных доп-меток Поехали
- Branch: `main`
- Methods: `добавил импорт КТ/ККТТ как brake_end`, `исключил их из ложных сигналов`, `отрисовка НТ/КТ стала приоритетной/без пунктирного шума`, `увеличен лимит видимых подписей меток режима`, `пересобран regime-maps через временное pdfplumber окружение`, `cache bump`
- Files: `scripts/import-regime-maps.py`, `scripts/poekhali-tracker.js`, `assets/tracker/regime-maps.json`, `scripts/app-constants.js`, `sw.js`

## 2026-05-05 12:15:57 +0000

- Source: `manual`
- Task: Аудит и исправление скоростей Поехали
- Branch: `main`
- Methods: `скорости из assets/docs/speeds теперь парсятся не только как постоянные ограничения`, `но и как базовые установленные скорости из табличных строк`, `speed-docs расширен до 217 правил`, `активная скорость и визуальные полосы отдают приоритет документам/предупреждениям над устаревшими ЭК/РК значениями`, `cache bump v293`
- Files: `scripts/import-speed-docs.py`, `assets/tracker/speed-docs.json`, `scripts/poekhali-tracker.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-06 00:19:04 +0000

- Source: `manual`
- Task: Откатил ошибочные UI-правки по серому тексту
- Branch: `main`
- Methods: `по просьбе пользователя revert трёх последних UI-коммитов: календарный summary и hero metadata/route duplicate`, `скорости и предыдущие Поехали-изменения не тронуты`, `smoke/local и reload PM2 выполнены`
- Files: `scripts/render.js`, `scripts/time-utils.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-06 00:21:08 +0000

- Source: `manual`
- Task: Исправил текст пустого дня в календаре
- Branch: `main`
- Methods: `в renderHomeCalendarDaySheet для пустой даты заменил дублирующиеся сообщения: верхняя подпись 'Свободный день.'`, `нижний блок с действием про добавление смены`, `cache bump v294`
- Files: `scripts/render.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-06 00:26:15 +0000

- Source: `manual`
- Task: Уточнил станции Комсомольска в Поехали
- Branch: `main`
- Methods: `общий КОМСОМ/Комсомольск теперь не показывается как 'Комсомольск': по координате форматируется в Комсомольск-2`, `Комсомольск Груз или Комсомольск Сорт`, `обновлены общий formatter и fallback tracker formatter`, `cache bump v295`
- Files: `scripts/time-utils.js`, `scripts/poekhali-tracker.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-06 00:39:00 +0000

- Source: `manual`
- Task: Добавил ручной выбор пути для двухпутных скоростей Поехали
- Branch: `main`
- Methods: `импорт speed-docs теперь сохраняет wayNumber для строк`, `где в таблице разные перегонные скорости по 1/2 пути`, `speed-doc правила фильтруются по выбранному П:1/П:2`, `общие правила остаются для всех`, `кнопка пути показана в HUD и переключает tracker.wayNumber`, `cache bump v296`
- Files: `scripts/import-speed-docs.py`, `assets/tracker/speed-docs.json`, `scripts/poekhali-tracker.js`, `index.html`, `scripts/app-constants.js`, `sw.js`

## 2026-05-06 00:42:18 +0000

- Source: `manual`
- Task: Перенес кнопку пути рядом с GPS
- Branch: `main`
- Methods: `btnPoekhaliWay перемещен в poekhali-top-tray рядом с GPS`, `CSS переопределяет старый display:none для активной верхней панели`, `cache bump v297`
- Files: `index.html`, `styles/10-navigation-and-cards.css`, `scripts/app-constants.js`, `sw.js`

## 2026-05-06 00:44:58 +0000

- Source: `manual`
- Task: Сделал кнопку пути аккуратной рядом с GPS
- Branch: `main`
- Methods: `кнопка П:1/П:2 оставлена слева от GPS в верхнем tray`, `убран служебный label Путь`, `стиль приведен к GPS-плашке`, `добавлены классы is-way-1/is-way-2 с разным цветовым акцентом`, `cache bump v298`
- Files: `index.html`, `styles/10-navigation-and-cards.css`, `scripts/poekhali-tracker.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-06 00:47:36 +0000

- Source: `manual`
- Task: Исправил налезание кнопки пути на GPS
- Branch: `main`
- Methods: `у кнопок внутри poekhali-top-tray сброшены left/bottom от старого absolute-layout`, `поэтому П:1/П:2 больше не смещается под GPS`, `акценты переведены на существующие переменные приложения: П1 accent`, `П2 green`, `cache bump v299`
- Files: `styles/10-navigation-and-cards.css`, `scripts/app-constants.js`, `sw.js`

## 2026-05-06 00:51:00 +0000

- Source: `manual`
- Task: Убрал фоновые виброотклики Поехали на стоянке
- Branch: `main`
- Methods: `live alert по ближайшему объекту теперь ставит silentHaptic при скорости ниже 3 км/ч: визуальная подсказка остается`, `но haptic не повторяется каждые 12/30 секунд пока стоим`, `превышение скорости и реальные события остаются с вибро`, `cache bump v300`
- Files: `scripts/poekhali-tracker.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-06 14:42:16 +0000

- Source: `manual`
- Task: Исправил направление Поехали по фактическому GPS-смещению
- Branch: `main`
- Methods: `добавил корректировку направления активной поездки по дельте соседних GPS-точек`, `подтвердил на живой записи`, `что координата уменьшается при сохранённом ЧЕТ`, `bumped SW cache`
- Files: `scripts/poekhali-tracker.js`, `sw.js`

## 2026-05-06 14:51:45 +0000

- Source: `manual`
- Task: Исправил подписи станций и удержание профиля Поехали на рабочем участке
- Branch: `main`
- Methods: `убрал остаточные автосокращения названий`, `расширил подпись станции на профиле`, `добавил выбор GPS-проекции с приоритетом недавнего/маршрутного участка`, `чтобы профиль и объекты не прыгали на соседний участок`
- Files: `scripts/poekhali-tracker.js`, `scripts/time-utils.js`, `sw.js`

## 2026-05-06 14:53:30 +0000

- Source: `manual`
- Task: Исправил яму профиля у Хальгасо
- Branch: `main`
- Methods: `проверил profile.xml вокруг Хальгасо`, `визуальный профиль теперь строится по физическому уклону карты`, `без инверсии под направление`, `знак уклона для машиниста остается отдельной текстовой логикой`
- Files: `scripts/poekhali-tracker.js`, `sw.js`

## 2026-05-06 14:55:07 +0000

- Source: `manual`
- Task: Зафиксировал единую физическую линию для объектов и скоростей Поехали
- Branch: `main`
- Methods: `getCurrentObjectFileKey больше не переключает объектный XML по направлению`, `направление меняет только движение состава и префиксы сигналов`, `а профиль/станции/скорости остаются на одном физическом пути`
- Files: `scripts/poekhali-tracker.js`, `sw.js`

## 2026-05-06 15:58:15 +0000

- Source: `manual`
- Task: Добавил ручные скорости и ОМ для БАМ-участка Постышево—Силинка
- Branch: `main`
- Methods: `по сообщению пользователя добавлен приоритетный manual слой скоростей для сектора 18 с путевой привязкой П1/П2 и метками ОМ`, `manual правила имеют высший приоритет над XML/РК/документами`
- Files: `scripts/poekhali-tracker.js`, `sw.js`

## 2026-05-06 15:59:44 +0000

- Source: `manual`
- Task: Исправил раскрытие ХУРМУЛ в Хурмули
- Branch: `main`
- Methods: `добавил вариант XML-сокращения 'хурмул' в форматтеры названий Поехали`, `bumped SW cache`
- Files: `scripts/poekhali-tracker.js`, `scripts/time-utils.js`, `sw.js`

## 2026-05-06 16:01:35 +0000

- Source: `manual`
- Task: Синхронизировал версию кэша на главной
- Branch: `main`
- Methods: `обновил SHELL_CACHE_VERSION в app-constants до v306`, `чтобы главная показывала актуальную версию service worker`
- Files: `scripts/app-constants.js`

## 2026-05-06 16:02:27 +0000

- Source: `manual`
- Task: Зафиксировал правило версии кэша на главной
- Branch: `main`
- Methods: `добавлена память: при изменении CACHE_VERSION в sw.js обязательно синхронизировать SHELL_CACHE_VERSION в scripts/app-constants.js`, `иначе главная показывает старую версию`
- Files: `ai-memory/CHANGELOG.md`

## 2026-05-06 16:08:41 +0000

- Source: `manual`
- Task: Исправил верхний блок Поехали для ограничений
- Branch: `main`
- Methods: `верхний HUD теперь пишет человеческий текст без ОГР`, `а расстояние активного ограничения берёт тем же способом`, `что полоса скоростей над профилем: до очистки ограничения хвостом поезда`, `CACHE_VERSION/SHELL_CACHE_VERSION подняты до v307`
- Files: `scripts/poekhali-tracker.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-06 18:30:19 +0000

- Source: `manual`
- Task: Нормализовал названия станций Поехали
- Branch: `main`
- Methods: `добавил единый словарь отображения коротких названий ЭК/РК для верхнего блока и серых подписей профиля: МАВРИН→Мавринский`, `ПОСТЫШ→Постышево`, `ХАРПИЧ→Харпичан`, `СИЛИНК→Силинка`, `ХУРМУЛ→Хурмули`, `ХАЛЬГА→Хальгасо и др.`, `синхронизировал PWA cache v308`
- Files: `scripts/poekhali-tracker.js`, `scripts/time-utils.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-06 19:48:31 +0000

- Source: `manual`
- Task: Исправил системные ошибки Поехали: станции, ПР, ОМ, Пиль
- Branch: `main`
- Methods: `станции/сигналы теперь выбираются как цели только впереди по направлению движения и после прохода не должны показывать растущую дистанцию`, `активное ПР имеет приоритет над обычными/ручными ограничениями и верхний HUD пишет вытягивание хвоста по ПР`, `добавлен быстрый ввод ПР строкой вида '3732км 9пк скорость 25' с отображением на профиле`, `нейтральные/обрывные места в UI переименованы из НТ в ОМ`, `для Пиль расширена зона 60 км/ч по П1/П2 и сигналы берутся из direction-specific XML`, `для П2 нечетного отображается НМ2А`, `подписи станций/сигналов разнесены по высоте`, `PWA cache v309`
- Files: `scripts/poekhali-tracker.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-06 19:51:02 +0000

- Source: `manual`
- Task: Исправил ранний захват станций и старые скорости на профиле
- Branch: `main`
- Methods: `архитектурно свернул дубль-объекты станций: для навигации берётся короткая станционная точка`, `а длинная зона станции больше не даёт HUD '0 м' за километры до станции`, `убран режим удержания станции внутри длинной зоны`, `отображение скоростей теперь сильнее подавляет старые РК/ЭК/скоростные объекты`, `если рядом есть ручное фактическое ограничение/ПР`, `CACHE_VERSION/SHELL_CACHE_VERSION подняты до v310`
- Files: `scripts/poekhali-tracker.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-06 22:23:36 +0000

- Source: `manual`
- Task: Спрятал служебные/старые скорости из интерфейса Поехали
- Branch: `main`
- Methods: `профиль`, `верхний HUD и следующая скорость теперь показывают только фактический слой: ручные правила/ПР/GPS`, `старые ЭК/РК/ДОК/ОГР используются только как данные`, `но не выводятся в водительский UI`, `у ручного слоя убраны префиксы БАМ/GPS — показывается просто скорость`, `у ПР остаётся ПР`, `next restriction ищется только среди фактических правил`, `cache v311`
- Files: `scripts/poekhali-tracker.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-06 22:28:23 +0000

- Source: `manual`
- Task: Убрал ПР из водительского отображения скоростей
- Branch: `main`
- Methods: `в Поехали все водительские speed-labels теперь без источников: предупреждения`, `ручные и GPS-скорости показываются как '60 км/ч'`, `'40 км/ч'`, `'25 км/ч'`, `HUD пишет '40 км/ч: вытянем хвост через…' без ПР`, `CACHE_VERSION/SHELL_CACHE_VERSION подняты до v312`
- Files: `scripts/poekhali-tracker.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-06 22:32:17 +0000

- Source: `manual`
- Task: Добавил ручные сигналы и станцию Апкан
- Branch: `main`
- Methods: `добавлен ручной слой объектов BAM-MANUAL для участка 18: станция Апкан и входные/выходные сигналы по четной/нечетной стороне и по путям (Ч`, `Ч1/Ч2`, `Н`, `Н1/Н2)`, `ручной слой подмешивается в track objects перед пользовательскими объектами`, `Апкан добавлен в нормализацию названий`, `cache v313`
- Files: `scripts/poekhali-tracker.js`, `scripts/time-utils.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-06 22:37:29 +0000

- Source: `manual`
- Task: Исправил отображение станции в пределах станции и направление маршрутных сигналов
- Branch: `main`
- Methods: `при нахождении состава внутри станционного диапазона верхний блок теперь держит название станции до выхода со станции`, `current-station ищется по всем объектным XML выбранного пути`, `чтобы ловить длинные зоны станции вроде Болена`, `направление сигнальных литеров теперь берется из маршрута смены/готовой route suggestion (Постышево => НЕЧ) перед GPS`, `и signal XML выбирается по этому effective direction`, `чтобы ЧМ1Г при следовании на Постышево отображался как НМ1Г`, `cache v314`
- Files: `scripts/poekhali-tracker.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-06 22:41:58 +0000

- Source: `manual`
- Task: Разделил подсветку сигналов от хвоста состава
- Branch: `main`
- Methods: `следующий сигнал и яркая красная подсветка теперь считаются от головы по effective signal direction`, `а не по близости к центру/хвосту`, `сигналы под хвостом/позади приглушаются и не получают литер в фокусе`, `findNextTrackObjectForDirection для сигналов использует effective направление маршрута`, `cache v315`
- Files: `scripts/poekhali-tracker.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-06 22:46:03 +0000

- Source: `manual`
- Task: Вернул следующую цель отдельно от текущей станции
- Branch: `main`
- Methods: `текущая станция больше не подменяет nextTarget/nextStation`, `в HUD она рисуется отдельной менее акцентной строкой над основной целью`, `а основная строка снова остаётся ближайшим сигналом/ограничением/целью впереди`, `cache v316`
- Files: `scripts/poekhali-tracker.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-06 23:53:11 +0000

- Source: `manual`
- Task: Устранил зависание при входе в Поехали
- Branch: `main`
- Methods: `закэшировал effective signal direction на короткий интервал`, `чтобы draw/profile loop не пересчитывал route suggestion для каждого сигнала`, `anchor для сигналов теперь строится тем же effective direction`, `cache v317`
- Files: `scripts/poekhali-tracker.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-07 00:58:35 +0000

- Source: `manual`
- Task: Починил открытие списка серии локомотива после режима Поехали
- Branch: `main`
- Methods: `добавил pointerup/touchend fallback для кастомного селекта серии локомотива`, `чтобы Telegram/iOS WebView не зависел только от synthetic click после fullscreen canvas`, `добавил защиту от двойного toggle`, `проверил Playwright tap open/close`, `cache v318`
- Files: `scripts/shift-form.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-07 01:05:54 +0000

- Source: `manual`
- Task: Перевёл выбор серии локомотива на нативный select
- Branch: `main`
- Methods: `кастомная кнопка теперь только визуальная`, `настоящий select лежит поверх неё внутри glass-select`, `поэтому Telegram/iOS открывает системный список без зависимости от кастомного overlay/click`, `проверил совпадение rect select/trigger`, `cache v319`
- Files: `index.html`, `styles/20-form-and-stats.css`, `scripts/render.js`, `scripts/shift-form.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-07 01:08:38 +0000

- Source: `manual`
- Task: Архитектурно переделал выбор серии локомотива
- Branch: `main`
- Methods: `убрал кастомный dropdown/portal/overlay для серии`, `оставил один настоящий select как единственный источник состояния`, `стилизованный optional-control`, `удалил обработчики pointer/touch/menu positioning для серии`, `проверил JS syntax и Playwright`, `что select видимый`, `доступный и меняет value/is-placeholder`, `cache v320`
- Files: `index.html`, `styles/20-form-and-stats.css`, `scripts/render.js`, `scripts/shift-form.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-07 01:13:32 +0000

- Source: `manual`
- Task: Вернул красивый dropdown серии локомотива без костылей
- Branch: `main`
- Methods: `сделал inline custom select: кнопка и скроллируемый список живут внутри поля без portal/fixed overlay`, `скрытый select остаётся единственным хранилищем value`, `открытая optional-card получает has-open-select для правильного z-index поверх следующих карточек`, `scroll больше не закрывает список`, `проверил Playwright open/select/close`, `cache v321`
- Files: `index.html`, `styles/20-form-and-stats.css`, `scripts/render.js`, `scripts/shift-form.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-07 01:16:52 +0000

- Source: `manual`
- Task: Исправил реальную причину поломки dropdown серии
- Branch: `main`
- Methods: `нашёл и убрал рекурсию updateSelectPlaceholderState -> syncLocoSeriesTrigger -> updateSelectPlaceholderState`, `из-за которой браузерный JS мог падать при инициализации красивого dropdown`, `проверил boot/open/select/close в Playwright без pageerror`, `cache v322`
- Files: `scripts/render.js`, `sw.js`, `scripts/app-constants.js`

## 2026-05-07 05:58:23 +0000

- Source: `manual`
- Task: Исправил наложение скоростей на карте Поехали
- Branch: `main`
- Methods: `увеличил вертикальный шаг дорожек скоростей в canvas`, `пересчитал верхнюю границу блока и синхронно поднял версию shell/sw cache`
- Files: `scripts/poekhali-tracker.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-07 06:23:30 +0000

- Source: `manual`
- Task: Добавил автоматическое восстановление GPS после паузы Поехали
- Branch: `main`
- Methods: `оставил GPS-watch активным для не вручную поставленной на паузу поездки`, `при возврате валидной GPS-проекции автоматически возобновляю запись`, `ручную паузу защищаю флагом`, `обновил cache version`
- Files: `scripts/poekhali-tracker.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-12 23:38:15 +1000

- Source: `post-commit`
- Task: feat(admin): add isolated admin panel
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `admin.html`, `ecosystem.config.js`, `scripts/admin.js`, `server.js`, `styles/admin.css`
- Notes: Commit: `5dcdf17a36db193aaed57c87dcce3bf6851534c4` (`5dcdf17`) | Author: `iEgor72`

## 2026-05-12 23:47:03 +1000

- Source: `post-commit`
- Task: fix(admin): load admin ids from ecosystem config
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `server.js`
- Notes: Commit: `67517c5ae8f571d97c8adc89d231ebcea79952a7` (`67517c5`) | Author: `iEgor72`

## 2026-05-12 23:51:40 +1000

- Source: `manual`
- Task: Committed, pushed, deployed, and restarted admin panel
- Branch: `main`
- Methods: `Synced main with origin`, `committed admin panel and admin ID fallback`, `pushed main`, `pulled production to 67517c5`, `restarted PM2 via ecosystem.config.js`, `verified local production HTTP and external GET /admin`
- Files: `server.js`, `ecosystem.config.js`, `admin.html`, `scripts/admin.js`, `styles/admin.css`

## 2026-05-12 23:55:16 +1000

- Source: `post-commit`
- Task: fix(admin): bypass app shell fallback
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `scripts/app-constants.js`, `server.js`, `sw.js`
- Notes: Commit: `f0eac1095bcecc28f1679c96fc3a84adfbf3add7` (`f0eac10`) | Author: `iEgor72`

## 2026-05-12 23:56:56 +1000

- Source: `manual`
- Task: Fixed admin route service worker fallback
- Branch: `main`
- Methods: `Excluded /admin and /admin.html from app-shell navigation fallback`, `bumped shell cache to v325`, `deployed f0eac10 and verified VPS local /admin serves admin-shell`
- Files: `sw.js`, `scripts/app-constants.js`, `server.js`

## 2026-05-13 00:00:58 +1000

- Source: `post-commit`
- Task: fix(admin): require auth before rendering panel
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `admin.html`, `scripts/admin.js`, `styles/admin.css`
- Notes: Commit: `73feedd6d0b889b9335bbb66689a00d4bae9730a` (`73feedd`) | Author: `iEgor72`

## 2026-05-13 00:01:35 +1000

- Source: `manual`
- Task: Locked admin shell behind auth check
- Branch: `main`
- Methods: `Admin page now starts locked`, `hides navigation/content until /api/admin/me succeeds`, `and sends shift_tracker_session_token as bearer auth`, `committed`, `pushed`, `deployed 73feedd`, `restarted PM2`
- Files: `admin.html`, `styles/admin.css`, `scripts/admin.js`

## 2026-05-13 00:12:35 +1000

- Source: `post-commit`
- Task: feat(admin): make panel more user friendly
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `admin.html`, `scripts/admin.js`, `scripts/app-constants.js`, `server.js`, `styles/admin.css`, `sw.js`
- Notes: Commit: `6a41adc048c406b060cf9c0c8fda5127658d53d1` (`6a41adc`) | Author: `iEgor72`

## 2026-05-13 00:13:44 +1000

- Source: `manual`
- Task: Made admin panel user friendly
- Branch: `main`
- Methods: `Renamed sections`, `added plain-language guide cards`, `visual metric bars`, `storage bars`, `safer tech mode warnings`, `cache v326`, `committed`, `pushed`, `deployed 6a41adc and restarted PM2`
- Files: `admin.html`, `scripts/admin.js`, `styles/admin.css`, `scripts/app-constants.js`, `server.js`, `sw.js`

## 2026-05-13 00:45:23 +1000

- Source: `manual`
- Task: Built visual admin constructor screens
- Branch: `main`
- Methods: `Added no-cache admin runtime handling`, `drag-and-drop document uploads`, `card-based trip view`, `visual warning editor`, `and GPS section map constructor`
- Files: `scripts/admin.js`, `styles/admin.css`, `server.js`, `sw.js`, `scripts/docs-app.js`, `scripts/app-constants.js`

## 2026-05-13 00:49:02 +1000

- Source: `post-commit`
- Task: feat(admin): add visual constructor tools
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `scripts/admin.js`, `scripts/app-constants.js`, `scripts/docs-app.js`, `server.js`, `styles/admin.css`, `sw.js`
- Notes: Commit: `12b83a38bc82ee4b610360d71f71820e70ebc82d` (`12b83a3`) | Author: `iEgor72`

## 2026-05-13 00:57:11 +1000

- Source: `manual`
- Task: Committed, pushed, deployed visual admin constructor
- Branch: `main`
- Methods: `Committed 12b83a3`, `pushed main`, `fast-forwarded production to 12b83a3`, `reloaded PM2`, `verified external /admin`, `admin.js constructor text`, `and docs manifest`
- Files: `scripts/admin.js`, `styles/admin.css`, `server.js`, `sw.js`, `scripts/docs-app.js`, `scripts/app-constants.js`

## 2026-05-13 01:10:26 +1000

- Source: `manual`
- Task: Переделка админки в визуальную панель: скрыт технический режим, начаты карточки людей и проектирование визуального конструктора карты Поехали
- Branch: `main`
- Methods: `Изучены admin.html/scripts/admin.js/styles/admin.css/server.js/scripts/poekhali-tracker.js`, `найдены источники скоростей и объектов Поехали`
- Files: `admin.html`, `scripts/admin.js`, `styles/admin.css`, `server.js`, `scripts/poekhali-tracker.js`

## 2026-05-13 01:28:17 +1000

- Source: `manual`
- Task: Сделан первый уровень визуальной админки
- Branch: `main`
- Methods: `Добавлен раздел Карта Поехали с карточками участков`, `ползунками скоростей и светофорами`, `добавлены API хранения admin-poekhali-map.json и публичная подгрузка в Поехали`, `улучшены карточки людей и заглушка отказа доступа`
- Files: `admin.html`, `scripts/admin.js`, `styles/admin.css`, `server.js`, `scripts/poekhali-tracker.js`

## 2026-05-13 01:32:22 +1000

- Source: `post-commit`
- Task: feat(admin): add visual Poekhali map editor
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `admin.html`, `scripts/admin.js`, `scripts/poekhali-tracker.js`, `server.js`, `styles/admin.css`
- Notes: Commit: `eddb0946d75eaffef88cb0a838cc625e3c384523` (`eddb094`) | Author: `iEgor72`

## 2026-05-13 01:43:19 +1000

- Source: `manual`
- Task: Задеплоен визуальный первый уровень админки
- Branch: `main`
- Methods: `Коммит eddb094 запушен в origin/main`, `на production /opt/bloknot-mashinista выполнен fast-forward до eddb094`, `node -c для server/admin/poekhali прошел`, `PM2 bloknot-mashinista перезапущен и был online`, `локальная production-проверка через 127.0.0.1:3000/admin вернула 200`, `внешняя проверка домена с рабочей машины нестабильно таймаутится из-за TCP-доступности VPS`
- Files: `admin.html`, `scripts/admin.js`, `styles/admin.css`, `server.js`, `scripts/poekhali-tracker.js`

## 2026-05-13 07:53:05 +1000

- Source: `manual`
- Task: Начата доработка админки до полного визуального конструктора
- Branch: `main`
- Methods: `После обязательного memory preflight изучены admin.html scripts/admin.js styles/admin.css server.js`, `выбран scoped frontend-first подход без деплоя`
- Files: `admin.html`, `scripts/admin.js`, `styles/admin.css`, `server.js`

## 2026-05-13 08:01:05 +1000

- Source: `manual`
- Task: Админка расширена до визуального конструктора
- Branch: `main`
- Methods: `Добавлены пресеты смен и зарплаты`, `визуальные ограничения скорости`, `ручное создание GPS-участков`, `редактор маршрутов/скоростей/светофоров карты Поехали`, `конструктор разделов документов и карточки идей без prompt/JSON`, `проверены node -c и in-app browser на локальном сервере`
- Files: `scripts/admin.js`, `styles/admin.css`

## 2026-05-13 08:20:26 +1000

- Source: `manual`
- Task: Начата переработка админки в CMS-подобную панель
- Branch: `main`
- Methods: `После повторного preflight выбран WordPress-подобный слой: мастер действий`, `быстрый старт`, `понятные next-step сценарии поверх существующего визуального конструктора`
- Files: `admin.html`, `scripts/admin.js`, `styles/admin.css`

## 2026-05-13 08:23:33 +1000

- Source: `manual`
- Task: Админка доведена до CMS-подобного сценария
- Branch: `main`
- Methods: `Добавлен раздел Мастер`, `быстрые действия на главной по модели CMS`, `переходы от задач к нужным разделам с подсказкой следующего шага`, `документы упрощены через скрытые дополнительные поля`, `проверены node -c`, `diff --check и in-app browser`
- Files: `admin.html`, `scripts/admin.js`, `styles/admin.css`

## 2026-05-13 09:13:36 +1000

- Source: `manual`
- Task: Начат третий UX-проход админки после критики удобства
- Branch: `main`
- Methods: `Фокус смещён с карточек на снижение когнитивной нагрузки: глобальная строка действий`, `простой режим`, `скрытие технических полей карты и документов`
- Files: `admin.html`, `scripts/admin.js`, `styles/admin.css`

## 2026-05-13 09:19:28 +1000

- Source: `manual`
- Task: Доведена админка ближе к визуальному конструктору
- Branch: `main`
- Methods: `Добавлены мастер действий`, `глобальная строка Что нужно сделать`, `простой режим`, `командный поиск с синонимами`, `готовые пресеты для карты/скоростей/зарплаты/документов и скрытие технических полей в простом режиме`, `проверено в браузере на сценариях карта и файл`
- Files: `admin.html`, `scripts/admin.js`, `styles/admin.css`

## 2026-05-13 09:39:25 +1000

- Source: `manual`
- Task: Исправлен рассинхрон подписей документов между приложением и админкой
- Branch: `main`
- Methods: `Серверный docs manifest обогащён фактическими display-названиями и подписями для известных документов`, `пользовательский экран документов теперь уважает name/caption из manifest`, `проверено на разделе Инструкции в браузере`
- Files: `server.js`, `scripts/docs-app.js`

## 2026-05-13 09:44:41 +1000

- Source: `manual`
- Task: Админка переведена в понятный минимализм
- Branch: `main`
- Methods: `Сокращены тексты и действия на главной`, `вторичные блоки состояния`, `данных и разделов документов спрятаны в details`, `добавлен спокойный минимальный CSS-слой без декоративных метрик`, `градиентов и лишних подсказок`, `проверено в браузере`
- Files: `scripts/admin.js`, `styles/admin.css`

## 2026-05-13 09:55:12 +1000

- Source: `manual`
- Task: Расширен редактор скоростей Поехали на реальные направления ТЧЭ-9
- Branch: `main`
- Methods: `Админка стала строить список направлений из tch9-reference.json и подтягивать скорости из speed-docs.json по ВЛЧ/ВСГ/БАМ`, `добавлены направления Комсомольск-Волочаевка`, `Комсомольск-Высокогорная`, `Комсомольск-Постышево и обратные`, `сохранение оставлено как admin override с приоритетом выше документов`
- Files: `scripts/admin.js`, `styles/admin.css`

## 2026-05-13 10:51:05 +1000

- Source: `manual`
- Task: Этап 1: визуальный конструктор Карты Поехали (drag-and-drop, ползунки, popover)
- Branch: `main`
- Methods: `rewrite renderPoekhaliMap+bindPoekhaliMapEditor`, `pointer-events drag`, `zoom controls`, `inline popover with sliders/presets`, `compact summary list`
- Files: `scripts/admin.js`, `styles/admin.css`

## 2026-05-13 10:57:34 +1000

- Source: `manual`
- Task: Этап 2: визуальный конструктор Ограничений скорости (drag-and-drop, popover, дата/тогл/заметка)
- Branch: `main`
- Methods: `rewrite renderWarningsEditor`, `pointer-events drag`, `popover with speed/start/end sliders + presets + date + toggle + note`, `compact sorted summary list`, `zoom controls reuse`
- Files: `scripts/admin.js`, `styles/admin.css`

## 2026-05-13 15:41:57 +1000

- Source: `manual`
- Task: App Поехали: визуальный конструктор ограничений + фикс закрытия клавиатуры
- Branch: `main`
- Methods: `focus guard in renderOpsSheet (defer re-render while focus is in editable input`, `flush on focusout)`, `replace renderWarningsSection with canvas-first v2: sector chips + 25/40/60/80 + zoom`, `pointer-events drag of speed bars`, `inline popover with speed slider/presets`, `start/end sliders`, `note text input`, `date picker`, `on/off toggle`, `delete`, `compact summary list`, `advanced collapsible for quick/bulk/import`
- Files: `scripts/poekhali-tracker.js`, `styles/10-navigation-and-cards.css`

## 2026-05-13 15:53:29 +1000

- Source: `manual`
- Task: App Поехали ПР: убрал чипы участков, заменил 4 add-кнопки на одну, ввод км/ПК вместо ползунков координат
- Branch: `main`
- Methods: `single + Добавить предупреждение button (auto-pick sector from GPS)`, `replace start/end range sliders with km+pk number inputs in 4-column grid`, `toolbar collapses to add-button + count + zoom row`
- Files: `scripts/poekhali-tracker.js`, `styles/10-navigation-and-cards.css`

## 2026-05-13 16:15:09 +1000

- Source: `manual`
- Task: App Поехали ПР: datetime-local с авто-МСК, скрытие истёкших, опциональный конец КМ/ПК, удалён 'Быстрый ввод'
- Branch: `main`
- Methods: `getMoscowDateTimeString/getMoscowDateString helpers`, `normalizeDateValue/isWarningExpired/formatDateLabel handle both date and datetime-local`, `popover input type=datetime-local`, `new warnings default validUntil=Moscow now`, `end km/pk inputs optional (blank = single point at start)`, `filter expired except currently-selected`, `server normalizeDateOnly accepts datetime-local format`, `removed advanced quick/bulk/import section`
- Files: `scripts/poekhali-tracker.js`, `styles/10-navigation-and-cards.css`, `server.js`

## 2026-05-13 16:18:16 +1000

- Source: `manual`
- Task: App Поехали ПР: добавлена кнопка Сохранить в popover
- Branch: `main`
- Methods: `explicit Save button next to Удалить`, `force-reads speed/note/validUntil from inputs (defensive for unblurred edits)`, `then saveWarnings + close popover + requestDraw`, `popover-foot layout: space-between with green Save and red Удалить`
- Files: `scripts/poekhali-tracker.js`, `styles/10-navigation-and-cards.css`

## 2026-05-13 16:20:55 +1000

- Source: `manual`
- Task: App Поехали ПР: popover больше не вылезает за рамки — обычный блок под канвой
- Branch: `main`
- Methods: `popover now rendered as normal flow block after .poekhali-warn-stage (was absolute with translateX anchored to bar percent that caused right-edge overflow)`, `removed data-edge logic`, `transform`, `::before arrow`, `popover width=100% of section`, `no viewport calc`
- Files: `scripts/poekhali-tracker.js`, `styles/10-navigation-and-cards.css`

## 2026-05-13 16:24:28 +1000

- Source: `manual`
- Task: Проверен текущий статус перед commit/push/deploy
- Branch: `main`
- Methods: `Запущены git status`, `branch -vv`, `diff --stat`, `проверено наличие production path /opt/bloknot-mashinista`, `путь в этой среде не найден`
- Files: `ai-memory/PROJECT_STATE.md`, `ai-memory/WORKTREE_STATUS.md`

## 2026-05-13 16:26:45 +1000

- Source: `manual`
- Task: Проверены изменения перед коммитом
- Branch: `main`
- Methods: `Выполнены git diff --check`, `node -c для изменённых JS-файлов`, `npm run smoke:local`, `админка открыта на локальном сервере через in-app browser`, `вкладка Карта Поехали без console errors`
- Files: `admin.html`, `scripts/admin.js`, `scripts/docs-app.js`, `scripts/poekhali-tracker.js`, `server.js`, `styles/10-navigation-and-cards.css`, `styles/admin.css`

## 2026-05-13 16:27:31 +1000

- Source: `post-commit`
- Task: feat(poehali): refine visual warning editors
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `admin.html`, `ai-memory/CHANGELOG.md`, `ai-memory/INDEX.md`, `ai-memory/PROJECT_STATE.md`, `ai-memory/RECENT_COMMITS.md`, `ai-memory/WORKTREE_STATUS.md`, `ai-memory/sessions/2026-05-12.md`, `ai-memory/sessions/2026-05-13.md`, `scripts/admin.js`, `scripts/docs-app.js`, `scripts/poekhali-tracker.js`, `server.js`, `styles/10-navigation-and-cards.css`, `styles/admin.css`
- Notes: Commit: `5bf61c258f74d1c16b547dbf24000e0d1dcf92dd` (`5bf61c2`) | Author: `iEgor72`

## 2026-05-13 16:28:14 +1000

- Source: `post-commit`
- Task: chore(memory): record poekhali editor commit
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `ai-memory/CHANGELOG.md`, `ai-memory/INDEX.md`, `ai-memory/PROJECT_STATE.md`, `ai-memory/RECENT_COMMITS.md`, `ai-memory/WORKTREE_STATUS.md`, `ai-memory/sessions/2026-05-13.md`
- Notes: Commit: `fe93d44e87d9abc96e1c3e82f92bd20eae8384e5` (`fe93d44`) | Author: `iEgor72`

## 2026-05-13 16:33:32 +1000

- Source: `manual`
- Task: Commit/push/deploy визуальных редакторов Поехали
- Branch: `main`
...
## 2026-05-31 13:28:44 +1000

- Source: `post-commit`
- Task: feat(poekhali): manual speeds with 3 categories, replace recording UI
- Branch: `poekhali-rework`
- Methods: `git post-commit hook`, `automatic memory update`
...
## 2026-06-01 11:10:24 +1000

- Source: `post-commit`
- Task: feat(poekhali): visible + Скорость / + Предупреждение buttons above profile
- Branch: `poekhali-rework`
- Methods: `git post-commit hook`, `automatic memory update`
...
## 2026-06-01 11:23:13 +1000

- Source: `post-commit`
- Task: feat(poekhali): single speed/limit add button with 3-category toggle
- Branch: `poekhali-rework`
- Methods: `git post-commit hook`, `automatic memory update`
...
## 2026-06-01 11:46:54 +1000

- Source: `post-commit`
- Task: feat(poekhali): per-category speed lists, temporary-first, red delete, cleaner header
- Branch: `poekhali-rework`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `ai-memory/CHANGELOG.md`, `ai-memory/INDEX.md`, `ai-memory/PROJECT_STATE.md`, `ai-memory/RECENT_COMMITS.md`, `ai-memory/WORKTREE_STATUS.md`, `ai-memory/sessions/2026-06-01.md`, `scripts/poekhali-tracker.js`
...
## 2026-06-02 19:04:41 +1000

- Source: `post-commit`
- Task: Shift card: show MSK time + end date for overnight shifts
- Branch: `poekhali-rework`
- Methods: `git post-commit hook`, `automatic memory update`
...
## 2026-06-02 19:30:56 +1000

- Source: `post-commit`
- Task: Shift card data redesign: logical grouping (#c)
- Branch: `poekhali-rework`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `ai-memory/CHANGELOG.md`, `ai-memory/INDEX.md`, `ai-memory/PROJECT_STATE.md`, `ai-memory/RECENT_COMMITS.md`, `ai-memory/WORKTREE_STATUS.md`, `ai-memory/sessions/2026-06-02.md`, `scripts/render.js`, `scripts/time-utils.js`, `styles/50-design-refresh.css`
- Notes: Commit: `736c663239a6e854a7b581a0fe06e339e5852671` (`736c663`) | Author: `iEgor72`

## 2026-06-02 19:39:08 +1000

- Source: `post-commit`
- Task: Flat shift card (no accent badges) + edit recipient after the fact (#d)
- Branch: `poekhali-rework`
- Methods: `git post-commit hook`, `automatic memory update`
...
## 2026-06-07 21:00:10 +1000

- Source: `post-commit`
- Task: fix(docs): recently-opened renders as real cards, opens, refreshes live
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
...
## 2026-06-21 11:33:24 +1000

- Source: `manual`
- Task: Разблокировал service worker для Telegram WebView offline
- Branch: `main`
- Methods: `Удален ранний unregister/return в sw-register.js для Telegram user-agent`, `регистрация SW теперь выполняется и в Telegram WebView`, `shell cache bump до v371`
- Files: `scripts/sw-register.js`, `sw.js`, `scripts/app-constants.js`

## 2026-06-21 11:36:07 +1000

- Source: `post-commit`
- Task: fix: keep service worker in telegram webview
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
...
## 2026-06-21 12:15:13 +1000

- Source: `post-commit`
- Task: fix: make offline shell cold-start cache-first
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
...
## 2026-06-21 12:56:37 +1000

- Source: `manual`
- Task: Deployed offline fallback safeguards to production
- Branch: `main`
...
## 2026-06-21 13:17:12 +1000

- Source: `post-commit`
- Task: fix(notifications): archive read bell announcements
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `ai-memory/CHANGELOG.md`, `ai-memory/sessions/2026-06-21.md`, `index.html`, `scripts/app-constants.js`, `scripts/app-init.js`, `scripts/local-smoke.mjs`, `scripts/prod-cache-smoke.mjs`, `server.js`, `sw-bootstrap-v375.js`, `sw.js`
- Notes: Commit: `42f7046968d0eaa4671e162c285e5689f886dac0` (`42f7046`) | Author: `iEgor72`

## 2026-06-21 13:18:08 +1000

- Source: `manual`
- Task: Deployed bell cleanup and offline announcement
- Branch: `main`
...
## 2026-06-21 13:30:13 +1000

- Source: `manual`
- Task: Deployed nonblocking boot fallback fix
- Branch: `main`
...
## 2026-07-18 17:47:00 +1000

- Source: `post-commit`
- Task: fix: remove technical data controls from profile
- Branch: `main`
- Methods: `git post-commit hook`, `automatic memory update`
...
## 2026-08-11 08:02:01 +1000

- Source: `post-commit`
- Task: chore(memory): record product scope release
- Branch: `codex/new-shift-time-picker-step1`
- Methods: `git post-commit hook`, `automatic memory update`
- Files: `ai-memory/CHANGELOG.md`, `ai-memory/INDEX.md`, `ai-memory/PROJECT_STATE.md`, `ai-memory/RECENT_COMMITS.md`, `ai-memory/WORKTREE_STATUS.md`, `ai-memory/sessions/2026-08-11.md`
- Notes: Commit: `bcce718b303e19916baa1482bdebe12cb8013d21` (`bcce718`) | Author: `iEgor72`

## 2026-08-11 08:05:51 +1000

- Source: `manual`
- Task: deploy_product_scope_v392_to_production
- Branch: `codex/new-shift-time-picker-step1`
- Methods: `Committed and squash-released product cleanup as c3b5b86 on main`, `verified full predeploy and Poekhali JSON suites in clean worktree`, `fast-forwarded production`, `installed production dependencies`, `checked SQLite storage`, `reloaded PM2`, `cleared Telegram bot commands and updated menu button to v392`, `verified public HTTPS`, `PWA version`, `redirects`, `and production cache behavior`
- Files: `index.html`, `server.js`, `sw.js`, `scripts/setup-bot-webhook.py`, `scripts/app.js`, `scripts/app-init.js`, `scripts/render.js`, `docs/seo`, `assets/seo`

## 2026-08-11 08:11:48 +1000

- Source: `manual`
- Task: refresh_telegram_bot_welcome_copy_and_promo
- Branch: `codex/new-shift-time-picker-step1`
- Methods: `Replaced the obsolete welcome banner with a generated v392 banner based on the current home screen`, `rewrote start`, `fallback`, `and default bot copy around shifts`, `hours`, `calendar`, `documents`, `approximate home salary`, `and Poekhali`, `added current Telegram profile descriptions to setup`, `verified Python syntax`, `12 server tests`, `local smoke`, `and offline smoke`
- Files: `assets/welcome-promo.jpg`, `assets/welcome-promo-v392.png`, `server.js`, `scripts/setup-bot-webhook.py`, `tests/server/api.test.js`

## 2026-08-11 08:15:45 +1000

- Source: `manual`
- Task: audit_and_refresh_public_marketing_surfaces_v392
- Branch: `codex/new-shift-time-picker-step1`

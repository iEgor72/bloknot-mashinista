...
## 2026-04-26 16:10:02 +0000

- Source: `manual`
- Task: Fix Poekhali head direction from real train vector
- Branch: `main`
- Methods: `Train head still looked wrong because its angle followed profile tangent rather than actual movement vector. Added getTrainHeadingAngle() from tail-to-head geometry and used it for head rendering`, `plus compacted upper profile spacing further.`
- Files: `scripts/poekhali-tracker.js`, `ai-memory/CHANGELOG.md`, `ai-memory/sessions/2026-04-26.md`

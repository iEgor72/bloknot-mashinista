...
function buildWelcomeMessage(chatId, firstName) {
  ...
  return {
    ...
    caption:
      `${greeting}\n\n` +
      'Блокнот машиниста помогает:\n' +
      '📅 считать часы по сменам\n' +
      '💸 быстро рассчитывать зарплату\n' +
      '⏱ вести таймер смен и поездок\n' +
      '📚 держать документы под рукой\n\n' +
      'Открывай приложение кнопкой ниже. Данные привязаны к Telegram и доступны с любого устройства.',
    reply_markup: {
      inline_keyboard: [

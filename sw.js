...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v409/00-base.css',
  '/styles/v409/10-navigation-and-cards.css',
  '/styles/v409/10-shell-navigation.css',
  '/styles/v409/11-poekhali-entry.css',
  '/styles/v409/12-cards.css',
  '/styles/v409/13-dashboard-cards.css',
  '/styles/v409/14-stats-and-salary.css',
  '/styles/v409/15-settings-and-docs.css',
  '/styles/v409/16-overlays-and-actions.css',
  '/styles/v409/15-bottom-nav.css',
  '/styles/v409/16-press-feedback.css',
  '/styles/v409/20-form-and-stats.css',
  '/styles/v409/30-shifts-and-overlays.css',
  '/styles/v409/40-premium-refresh.css',
  '/styles/v409/50-design-refresh.css',
  '/styles/v409/50-theme-shell.css',
  '/styles/v409/51-shifts.css',
  '/styles/v409/52-poekhali.css',
  '/styles/v409/53-salary.css',
  '/styles/v409/54-docs.css',
  '/styles/v409/55-forms.css',
  '/styles/v409/56-overlays.css',
  '/styles/v409/56-profile.css',
  '/styles/v409/57-datetime-picker.css',
  ...
  '/scripts/v409/safe-area.js',
  '/scripts/v409/nav-debug.js',
  '/scripts/v409/utils/haptics.js',
  '/scripts/v409/press-feedback.js',
  '/scripts/v409/app-constants.js',
  '/scripts/v409/poekhali-station-names.js',
  '/scripts/v409/glass-select.js',
  '/scripts/v409/viewport.js',
  '/scripts/v409/time-utils.js',
  '/scripts/v409/docs-app.js',
  '/scripts/v409/telegram-sdk-loader.js',
  '/scripts/v409/app.js',
  '/scripts/v409/poekhali-utils.js',
  '/scripts/v409/poekhali-map-parser.js',
  '/scripts/v409/poekhali-warnings.js',
  '/scripts/v409/poekhali-backup.js',
  '/scripts/v409/poekhali-tracker.js',
  '/scripts/v409/auth.js',
  '/scripts/v409/render.js',
  '/scripts/v409/shift-form.js',
  '/scripts/v409/datetime-picker.js',
  '/scripts/v409/app-init.js',
  '/scripts/v409/sw-register.js',

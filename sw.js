...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v399/00-base.css',
  '/styles/v399/10-navigation-and-cards.css',
  '/styles/v399/10-shell-navigation.css',
  '/styles/v399/11-poekhali-entry.css',
  '/styles/v399/12-cards.css',
  '/styles/v399/13-dashboard-cards.css',
  '/styles/v399/14-stats-and-salary.css',
  '/styles/v399/15-settings-and-docs.css',
  '/styles/v399/16-overlays-and-actions.css',
  '/styles/v399/15-bottom-nav.css',
  '/styles/v399/16-press-feedback.css',
  '/styles/v399/20-form-and-stats.css',
  '/styles/v399/30-shifts-and-overlays.css',
  '/styles/v399/40-premium-refresh.css',
  '/styles/v399/50-design-refresh.css',
  '/styles/v399/50-theme-shell.css',
  '/styles/v399/51-shifts.css',
  '/styles/v399/52-poekhali.css',
  '/styles/v399/53-salary.css',
  '/styles/v399/54-docs.css',
  '/styles/v399/55-forms.css',
  '/styles/v399/56-overlays.css',
  '/styles/v399/56-profile.css',
  '/styles/v399/57-datetime-picker.css',
  ...
  '/scripts/v399/safe-area.js',
  '/scripts/v399/nav-debug.js',
  '/scripts/v399/utils/haptics.js',
  '/scripts/v399/press-feedback.js',
  '/scripts/v399/app-constants.js',
  '/scripts/v399/glass-select.js',
  '/scripts/v399/viewport.js',
  '/scripts/v399/time-utils.js',
  '/scripts/v399/docs-app.js',
  '/scripts/v399/telegram-sdk-loader.js',
  '/scripts/v399/app.js',
  '/scripts/v399/poekhali-utils.js',
  '/scripts/v399/poekhali-map-parser.js',
  '/scripts/v399/poekhali-warnings.js',
  '/scripts/v399/poekhali-backup.js',
  '/scripts/v399/poekhali-tracker.js',
  '/scripts/v399/auth.js',
  '/scripts/v399/render.js',
  '/scripts/v399/shift-form.js',
  '/scripts/v399/datetime-picker.js',
  '/scripts/v399/app-init.js',
  '/scripts/v399/sw-register.js',

...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v398/00-base.css',
  '/styles/v398/10-navigation-and-cards.css',
  '/styles/v398/10-shell-navigation.css',
  '/styles/v398/11-poekhali-entry.css',
  '/styles/v398/12-cards.css',
  '/styles/v398/13-dashboard-cards.css',
  '/styles/v398/14-stats-and-salary.css',
  '/styles/v398/15-settings-and-docs.css',
  '/styles/v398/16-overlays-and-actions.css',
  '/styles/v398/15-bottom-nav.css',
  '/styles/v398/16-press-feedback.css',
  '/styles/v398/20-form-and-stats.css',
  '/styles/v398/30-shifts-and-overlays.css',
  '/styles/v398/40-premium-refresh.css',
  '/styles/v398/50-design-refresh.css',
  '/styles/v398/50-theme-shell.css',
  '/styles/v398/51-shifts.css',
  '/styles/v398/52-poekhali.css',
  '/styles/v398/53-salary.css',
  '/styles/v398/54-docs.css',
  '/styles/v398/55-forms.css',
  '/styles/v398/56-overlays.css',
  '/styles/v398/56-profile.css',
  '/styles/v398/57-datetime-picker.css',
  ...
  '/scripts/v398/safe-area.js',
  '/scripts/v398/nav-debug.js',
  '/scripts/v398/utils/haptics.js',
  '/scripts/v398/press-feedback.js',
  '/scripts/v398/app-constants.js',
  '/scripts/v398/glass-select.js',
  '/scripts/v398/viewport.js',
  '/scripts/v398/time-utils.js',
  '/scripts/v398/docs-app.js',
  '/scripts/v398/telegram-sdk-loader.js',
  '/scripts/v398/app.js',
  '/scripts/v398/poekhali-utils.js',
  '/scripts/v398/poekhali-map-parser.js',
  '/scripts/v398/poekhali-warnings.js',
  '/scripts/v398/poekhali-backup.js',
  '/scripts/v398/poekhali-tracker.js',
  '/scripts/v398/auth.js',
  '/scripts/v398/render.js',
  '/scripts/v398/shift-form.js',
  '/scripts/v398/datetime-picker.js',
  '/scripts/v398/app-init.js',
  '/scripts/v398/sw-register.js',

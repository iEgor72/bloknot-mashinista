...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v407/00-base.css',
  '/styles/v407/10-navigation-and-cards.css',
  '/styles/v407/10-shell-navigation.css',
  '/styles/v407/11-poekhali-entry.css',
  '/styles/v407/12-cards.css',
  '/styles/v407/13-dashboard-cards.css',
  '/styles/v407/14-stats-and-salary.css',
  '/styles/v407/15-settings-and-docs.css',
  '/styles/v407/16-overlays-and-actions.css',
  '/styles/v407/15-bottom-nav.css',
  '/styles/v407/16-press-feedback.css',
  '/styles/v407/20-form-and-stats.css',
  '/styles/v407/30-shifts-and-overlays.css',
  '/styles/v407/40-premium-refresh.css',
  '/styles/v407/50-design-refresh.css',
  '/styles/v407/50-theme-shell.css',
  '/styles/v407/51-shifts.css',
  '/styles/v407/52-poekhali.css',
  '/styles/v407/53-salary.css',
  '/styles/v407/54-docs.css',
  '/styles/v407/55-forms.css',
  '/styles/v407/56-overlays.css',
  '/styles/v407/56-profile.css',
  '/styles/v407/57-datetime-picker.css',
  ...
  '/scripts/v407/safe-area.js',
  '/scripts/v407/nav-debug.js',
  '/scripts/v407/utils/haptics.js',
  '/scripts/v407/press-feedback.js',
  '/scripts/v407/app-constants.js',
  '/scripts/v407/poekhali-station-names.js',
  '/scripts/v407/glass-select.js',
  '/scripts/v407/viewport.js',
  '/scripts/v407/time-utils.js',
  '/scripts/v407/docs-app.js',
  '/scripts/v407/telegram-sdk-loader.js',
  '/scripts/v407/app.js',
  '/scripts/v407/poekhali-utils.js',
  '/scripts/v407/poekhali-map-parser.js',
  '/scripts/v407/poekhali-warnings.js',
  '/scripts/v407/poekhali-backup.js',
  '/scripts/v407/poekhali-tracker.js',
  '/scripts/v407/auth.js',
  '/scripts/v407/render.js',
  '/scripts/v407/shift-form.js',
  '/scripts/v407/datetime-picker.js',
  '/scripts/v407/app-init.js',
  '/scripts/v407/sw-register.js',

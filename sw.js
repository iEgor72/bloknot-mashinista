...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v406/00-base.css',
  '/styles/v406/10-navigation-and-cards.css',
  '/styles/v406/10-shell-navigation.css',
  '/styles/v406/11-poekhali-entry.css',
  '/styles/v406/12-cards.css',
  '/styles/v406/13-dashboard-cards.css',
  '/styles/v406/14-stats-and-salary.css',
  '/styles/v406/15-settings-and-docs.css',
  '/styles/v406/16-overlays-and-actions.css',
  '/styles/v406/15-bottom-nav.css',
  '/styles/v406/16-press-feedback.css',
  '/styles/v406/20-form-and-stats.css',
  '/styles/v406/30-shifts-and-overlays.css',
  '/styles/v406/40-premium-refresh.css',
  '/styles/v406/50-design-refresh.css',
  '/styles/v406/50-theme-shell.css',
  '/styles/v406/51-shifts.css',
  '/styles/v406/52-poekhali.css',
  '/styles/v406/53-salary.css',
  '/styles/v406/54-docs.css',
  '/styles/v406/55-forms.css',
  '/styles/v406/56-overlays.css',
  '/styles/v406/56-profile.css',
  '/styles/v406/57-datetime-picker.css',
  ...
  '/scripts/v406/safe-area.js',
  '/scripts/v406/nav-debug.js',
  '/scripts/v406/utils/haptics.js',
  '/scripts/v406/press-feedback.js',
  '/scripts/v406/app-constants.js',
  '/scripts/v406/poekhali-station-names.js',
  '/scripts/v406/glass-select.js',
  '/scripts/v406/viewport.js',
  '/scripts/v406/time-utils.js',
  '/scripts/v406/docs-app.js',
  '/scripts/v406/telegram-sdk-loader.js',
  '/scripts/v406/app.js',
  '/scripts/v406/poekhali-utils.js',
  '/scripts/v406/poekhali-map-parser.js',
  '/scripts/v406/poekhali-warnings.js',
  '/scripts/v406/poekhali-backup.js',
  '/scripts/v406/poekhali-tracker.js',
  '/scripts/v406/auth.js',
  '/scripts/v406/render.js',
  '/scripts/v406/shift-form.js',
  '/scripts/v406/datetime-picker.js',
  '/scripts/v406/app-init.js',
  '/scripts/v406/sw-register.js',

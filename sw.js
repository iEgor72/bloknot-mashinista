...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v412/00-base.css',
  '/styles/v412/10-navigation-and-cards.css',
  '/styles/v412/10-shell-navigation.css',
  '/styles/v412/11-poekhali-entry.css',
  '/styles/v412/12-cards.css',
  '/styles/v412/13-dashboard-cards.css',
  '/styles/v412/14-stats-and-salary.css',
  '/styles/v412/15-settings-and-docs.css',
  '/styles/v412/16-overlays-and-actions.css',
  '/styles/v412/15-bottom-nav.css',
  '/styles/v412/16-press-feedback.css',
  '/styles/v412/20-form-and-stats.css',
  '/styles/v412/30-shifts-and-overlays.css',
  '/styles/v412/40-premium-refresh.css',
  '/styles/v412/50-design-refresh.css',
  '/styles/v412/50-theme-shell.css',
  '/styles/v412/51-shifts.css',
  '/styles/v412/52-poekhali.css',
  '/styles/v412/53-salary.css',
  '/styles/v412/54-docs.css',
  '/styles/v412/55-forms.css',
  '/styles/v412/56-overlays.css',
  '/styles/v412/56-profile.css',
  '/styles/v412/57-datetime-picker.css',
  '/styles/v412/58-vu45.css',
  ...
  '/scripts/v412/safe-area.js',
  '/scripts/v412/nav-debug.js',
  '/scripts/v412/utils/haptics.js',
  '/scripts/v412/press-feedback.js',
  '/scripts/v412/app-constants.js',
  '/scripts/v412/locomotive-usage.js',
  '/scripts/v412/poekhali-station-names.js',
  '/scripts/v412/glass-select.js',
  '/scripts/v412/viewport.js',
  '/scripts/v412/time-utils.js',
  '/scripts/v412/docs-app.js',
  '/scripts/v412/telegram-sdk-loader.js',
  '/scripts/v412/app.js',
  '/scripts/v412/poekhali-utils.js',
  '/scripts/v412/poekhali-map-parser.js',
  '/scripts/v412/poekhali-warnings.js',
  '/scripts/v412/poekhali-backup.js',
  '/scripts/v412/poekhali-tracker.js',
  '/scripts/v412/auth.js',
  '/scripts/v412/render.js',
  '/scripts/v412/shift-form.js',
  '/scripts/v412/datetime-picker.js',
  '/scripts/v412/vu45-calculator.js',
  '/scripts/v412/vu45-ui.js',
  '/scripts/v412/app-init.js',
  '/scripts/v412/sw-register.js',

...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v396/00-base.css',
  '/styles/v396/10-navigation-and-cards.css',
  '/styles/v396/10-shell-navigation.css',
  '/styles/v396/11-poekhali-entry.css',
  '/styles/v396/12-cards.css',
  '/styles/v396/13-dashboard-cards.css',
  '/styles/v396/14-stats-and-salary.css',
  '/styles/v396/15-settings-and-docs.css',
  '/styles/v396/16-overlays-and-actions.css',
  '/styles/v396/15-bottom-nav.css',
  '/styles/v396/16-press-feedback.css',
  '/styles/v396/20-form-and-stats.css',
  '/styles/v396/30-shifts-and-overlays.css',
  '/styles/v396/40-premium-refresh.css',
  '/styles/v396/50-design-refresh.css',
  '/styles/v396/50-theme-shell.css',
  '/styles/v396/51-shifts.css',
  '/styles/v396/52-poekhali.css',
  '/styles/v396/54-docs.css',
  '/styles/v396/55-forms.css',
  '/styles/v396/56-overlays.css',
  '/styles/v396/56-profile.css',
  '/styles/v396/57-datetime-picker.css',
  ...
  '/scripts/v396/safe-area.js',
  '/scripts/v396/nav-debug.js',
  '/scripts/v396/utils/haptics.js',
  '/scripts/v396/press-feedback.js',
  '/scripts/v396/app-constants.js',
  '/scripts/v396/glass-select.js',
  '/scripts/v396/viewport.js',
  '/scripts/v396/time-utils.js',
  '/scripts/v396/docs-app.js',
  '/scripts/v396/telegram-sdk-loader.js',
  '/scripts/v396/app.js',
  '/scripts/v396/poekhali-utils.js',
  '/scripts/v396/poekhali-map-parser.js',
  '/scripts/v396/poekhali-warnings.js',
  '/scripts/v396/poekhali-backup.js',
  '/scripts/v396/poekhali-tracker.js',
  '/scripts/v396/auth.js',
  '/scripts/v396/render.js',
  '/scripts/v396/shift-form.js',
  '/scripts/v396/datetime-picker.js',
  '/scripts/v396/app-init.js',
  '/scripts/v396/sw-register.js',

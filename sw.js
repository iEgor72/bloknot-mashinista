...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v411/00-base.css',
  '/styles/v411/10-navigation-and-cards.css',
  '/styles/v411/10-shell-navigation.css',
  '/styles/v411/11-poekhali-entry.css',
  '/styles/v411/12-cards.css',
  '/styles/v411/13-dashboard-cards.css',
  '/styles/v411/14-stats-and-salary.css',
  '/styles/v411/15-settings-and-docs.css',
  '/styles/v411/16-overlays-and-actions.css',
  '/styles/v411/15-bottom-nav.css',
  '/styles/v411/16-press-feedback.css',
  '/styles/v411/20-form-and-stats.css',
  '/styles/v411/30-shifts-and-overlays.css',
  '/styles/v411/40-premium-refresh.css',
  '/styles/v411/50-design-refresh.css',
  '/styles/v411/50-theme-shell.css',
  '/styles/v411/51-shifts.css',
  '/styles/v411/52-poekhali.css',
  '/styles/v411/53-salary.css',
  '/styles/v411/54-docs.css',
  '/styles/v411/55-forms.css',
  '/styles/v411/56-overlays.css',
  '/styles/v411/56-profile.css',
  '/styles/v411/57-datetime-picker.css',
  '/styles/v411/58-vu45.css',
  ...
  '/scripts/v411/safe-area.js',
  '/scripts/v411/nav-debug.js',
  '/scripts/v411/utils/haptics.js',
  '/scripts/v411/press-feedback.js',
  '/scripts/v411/app-constants.js',
  '/scripts/v411/locomotive-usage.js',
  '/scripts/v411/poekhali-station-names.js',
  '/scripts/v411/glass-select.js',
  '/scripts/v411/viewport.js',
  '/scripts/v411/time-utils.js',
  '/scripts/v411/docs-app.js',
  '/scripts/v411/telegram-sdk-loader.js',
  '/scripts/v411/app.js',
  '/scripts/v411/poekhali-utils.js',
  '/scripts/v411/poekhali-map-parser.js',
  '/scripts/v411/poekhali-warnings.js',
  '/scripts/v411/poekhali-backup.js',
  '/scripts/v411/poekhali-tracker.js',
  '/scripts/v411/auth.js',
  '/scripts/v411/render.js',
  '/scripts/v411/shift-form.js',
  '/scripts/v411/datetime-picker.js',
  '/scripts/v411/vu45-calculator.js',
  '/scripts/v411/vu45-ui.js',
  '/scripts/v411/app-init.js',
  '/scripts/v411/sw-register.js',
  '/sw-bootstrap-v411.js'
];

...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v401/00-base.css',
  '/styles/v401/10-navigation-and-cards.css',
  '/styles/v401/10-shell-navigation.css',
  '/styles/v401/11-poekhali-entry.css',
  '/styles/v401/12-cards.css',
  '/styles/v401/13-dashboard-cards.css',
  '/styles/v401/14-stats-and-salary.css',
  '/styles/v401/15-settings-and-docs.css',
  '/styles/v401/16-overlays-and-actions.css',
  '/styles/v401/15-bottom-nav.css',
  '/styles/v401/16-press-feedback.css',
  '/styles/v401/20-form-and-stats.css',
  '/styles/v401/30-shifts-and-overlays.css',
  '/styles/v401/40-premium-refresh.css',
  '/styles/v401/50-design-refresh.css',
  '/styles/v401/50-theme-shell.css',
  '/styles/v401/51-shifts.css',
  '/styles/v401/52-poekhali.css',
  '/styles/v401/53-salary.css',
  '/styles/v401/54-docs.css',
  '/styles/v401/55-forms.css',
  '/styles/v401/56-overlays.css',
  '/styles/v401/56-profile.css',
  '/styles/v401/57-datetime-picker.css',
  ...
  '/scripts/v401/safe-area.js',
  '/scripts/v401/nav-debug.js',
  '/scripts/v401/utils/haptics.js',
  '/scripts/v401/press-feedback.js',
  '/scripts/v401/app-constants.js',
  '/scripts/v401/poekhali-station-names.js',
  '/scripts/v401/glass-select.js',
  '/scripts/v401/viewport.js',
  '/scripts/v401/time-utils.js',
  '/scripts/v401/docs-app.js',
  '/scripts/v401/telegram-sdk-loader.js',
  '/scripts/v401/app.js',
  '/scripts/v401/poekhali-utils.js',
  '/scripts/v401/poekhali-map-parser.js',
  '/scripts/v401/poekhali-warnings.js',
  '/scripts/v401/poekhali-backup.js',
  '/scripts/v401/poekhali-tracker.js',
  '/scripts/v401/auth.js',
  '/scripts/v401/render.js',
  '/scripts/v401/shift-form.js',
  '/scripts/v401/datetime-picker.js',
  '/scripts/v401/app-init.js',
  '/scripts/v401/sw-register.js',

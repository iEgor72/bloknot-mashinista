...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v417/00-base.css',
  '/styles/v417/10-navigation-and-cards.css',
  '/styles/v417/10-shell-navigation.css',
  '/styles/v417/11-poekhali-entry.css',
  '/styles/v417/12-cards.css',
  '/styles/v417/13-dashboard-cards.css',
  '/styles/v417/14-stats-and-salary.css',
  '/styles/v417/15-settings-and-docs.css',
  '/styles/v417/16-overlays-and-actions.css',
  '/styles/v417/15-bottom-nav.css',
  '/styles/v417/16-press-feedback.css',
  '/styles/v417/20-form-and-stats.css',
  '/styles/v417/30-shifts-and-overlays.css',
  '/styles/v417/40-premium-refresh.css',
  '/styles/v417/50-design-refresh.css',
  '/styles/v417/50-theme-shell.css',
  '/styles/v417/51-shifts.css',
  '/styles/v417/52-poekhali.css',
  '/styles/v417/53-salary.css',
  '/styles/v417/54-docs.css',
  '/styles/v417/55-forms.css',
  '/styles/v417/56-overlays.css',
  '/styles/v417/56-profile.css',
  '/styles/v417/57-datetime-picker.css',
  '/styles/v417/58-vu45.css',
  ...
  '/scripts/v417/safe-area.js',
  '/scripts/v417/nav-debug.js',
  '/scripts/v417/utils/haptics.js',
  '/scripts/v417/press-feedback.js',
  '/scripts/v417/app-constants.js',
  '/scripts/v417/locomotive-usage.js',
  '/scripts/v417/poekhali-station-names.js',
  '/scripts/v417/glass-select.js',
  '/scripts/v417/viewport.js',
  '/scripts/v417/time-utils.js',
  '/scripts/v417/docs-app.js',
  '/scripts/v417/telegram-sdk-loader.js',
  '/scripts/v417/app.js',
  '/scripts/v417/poekhali-utils.js',
  '/scripts/v417/poekhali-map-parser.js',
  '/scripts/v417/poekhali-warnings.js',
  '/scripts/v417/poekhali-backup.js',
  '/scripts/v417/poekhali-tracker.js',
  '/scripts/v417/auth.js',
  '/scripts/v417/render.js',
  '/scripts/v417/shift-form.js',
  '/scripts/v417/datetime-picker.js',
  '/scripts/v417/vu45-calculator.js',
  '/scripts/v417/vu45-ui.js',
  '/scripts/v417/app-init.js',
  '/scripts/v417/sw-register.js',

...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v403/00-base.css',
  '/styles/v403/10-navigation-and-cards.css',
  '/styles/v403/10-shell-navigation.css',
  '/styles/v403/11-poekhali-entry.css',
  '/styles/v403/12-cards.css',
  '/styles/v403/13-dashboard-cards.css',
  '/styles/v403/14-stats-and-salary.css',
  '/styles/v403/15-settings-and-docs.css',
  '/styles/v403/16-overlays-and-actions.css',
  '/styles/v403/15-bottom-nav.css',
  '/styles/v403/16-press-feedback.css',
  '/styles/v403/20-form-and-stats.css',
  '/styles/v403/30-shifts-and-overlays.css',
  '/styles/v403/40-premium-refresh.css',
  '/styles/v403/50-design-refresh.css',
  '/styles/v403/50-theme-shell.css',
  '/styles/v403/51-shifts.css',
  '/styles/v403/52-poekhali.css',
  '/styles/v403/53-salary.css',
  '/styles/v403/54-docs.css',
  '/styles/v403/55-forms.css',
  '/styles/v403/56-overlays.css',
  '/styles/v403/56-profile.css',
  '/styles/v403/57-datetime-picker.css',
  ...
  '/scripts/v403/safe-area.js',
  '/scripts/v403/nav-debug.js',
  '/scripts/v403/utils/haptics.js',
  '/scripts/v403/press-feedback.js',
  '/scripts/v403/app-constants.js',
  '/scripts/v403/poekhali-station-names.js',
  '/scripts/v403/glass-select.js',
  '/scripts/v403/viewport.js',
  '/scripts/v403/time-utils.js',
  '/scripts/v403/docs-app.js',
  '/scripts/v403/telegram-sdk-loader.js',
  '/scripts/v403/app.js',
  '/scripts/v403/poekhali-utils.js',
  '/scripts/v403/poekhali-map-parser.js',
  '/scripts/v403/poekhali-warnings.js',
  '/scripts/v403/poekhali-backup.js',
  '/scripts/v403/poekhali-tracker.js',
  '/scripts/v403/auth.js',
  '/scripts/v403/render.js',
  '/scripts/v403/shift-form.js',
  '/scripts/v403/datetime-picker.js',
  '/scripts/v403/app-init.js',
  '/scripts/v403/sw-register.js',
  '/sw-bootstrap-v403.js'
];

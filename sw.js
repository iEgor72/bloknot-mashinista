...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v410/00-base.css',
  '/styles/v410/10-navigation-and-cards.css',
  '/styles/v410/10-shell-navigation.css',
  '/styles/v410/11-poekhali-entry.css',
  '/styles/v410/12-cards.css',
  '/styles/v410/13-dashboard-cards.css',
  '/styles/v410/14-stats-and-salary.css',
  '/styles/v410/15-settings-and-docs.css',
  '/styles/v410/16-overlays-and-actions.css',
  '/styles/v410/15-bottom-nav.css',
  '/styles/v410/16-press-feedback.css',
  '/styles/v410/20-form-and-stats.css',
  '/styles/v410/30-shifts-and-overlays.css',
  '/styles/v410/40-premium-refresh.css',
  '/styles/v410/50-design-refresh.css',
  '/styles/v410/50-theme-shell.css',
  '/styles/v410/51-shifts.css',
  '/styles/v410/52-poekhali.css',
  '/styles/v410/53-salary.css',
  '/styles/v410/54-docs.css',
  '/styles/v410/55-forms.css',
  '/styles/v410/56-overlays.css',
  '/styles/v410/56-profile.css',
  '/styles/v410/57-datetime-picker.css',
  '/styles/v410/58-vu45.css',
  ...
  '/scripts/v410/safe-area.js',
  '/scripts/v410/nav-debug.js',
  '/scripts/v410/utils/haptics.js',
  '/scripts/v410/press-feedback.js',
  '/scripts/v410/app-constants.js',
  '/scripts/v410/locomotive-usage.js',
  '/scripts/v410/poekhali-station-names.js',
  '/scripts/v410/glass-select.js',
  '/scripts/v410/viewport.js',
  '/scripts/v410/time-utils.js',
  '/scripts/v410/docs-app.js',
  '/scripts/v410/telegram-sdk-loader.js',
  '/scripts/v410/app.js',
  '/scripts/v410/poekhali-utils.js',
  '/scripts/v410/poekhali-map-parser.js',
  '/scripts/v410/poekhali-warnings.js',
  '/scripts/v410/poekhali-backup.js',
  '/scripts/v410/poekhali-tracker.js',
  '/scripts/v410/auth.js',
  '/scripts/v410/render.js',
  '/scripts/v410/shift-form.js',
  '/scripts/v410/datetime-picker.js',
  '/scripts/v410/vu45-calculator.js',
  '/scripts/v410/vu45-ui.js',
  '/scripts/v410/app-init.js',
  '/scripts/v410/sw-register.js',

...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v397/00-base.css',
  '/styles/v397/10-navigation-and-cards.css',
  '/styles/v397/10-shell-navigation.css',
  '/styles/v397/11-poekhali-entry.css',
  '/styles/v397/12-cards.css',
  '/styles/v397/13-dashboard-cards.css',
  '/styles/v397/14-stats-and-salary.css',
  '/styles/v397/15-settings-and-docs.css',
  '/styles/v397/16-overlays-and-actions.css',
  '/styles/v397/15-bottom-nav.css',
  '/styles/v397/16-press-feedback.css',
  '/styles/v397/20-form-and-stats.css',
  '/styles/v397/30-shifts-and-overlays.css',
  '/styles/v397/40-premium-refresh.css',
  '/styles/v397/50-design-refresh.css',
  '/styles/v397/50-theme-shell.css',
  '/styles/v397/51-shifts.css',
  '/styles/v397/52-poekhali.css',
  '/styles/v397/53-salary.css',
  '/styles/v397/54-docs.css',
  '/styles/v397/55-forms.css',
  '/styles/v397/56-overlays.css',
  '/styles/v397/56-profile.css',
  '/styles/v397/57-datetime-picker.css',
  ...
  '/scripts/v397/safe-area.js',
  '/scripts/v397/nav-debug.js',
  '/scripts/v397/utils/haptics.js',
  '/scripts/v397/press-feedback.js',
  '/scripts/v397/app-constants.js',
  '/scripts/v397/glass-select.js',
  '/scripts/v397/viewport.js',
  '/scripts/v397/time-utils.js',
  '/scripts/v397/docs-app.js',
  '/scripts/v397/telegram-sdk-loader.js',
  '/scripts/v397/app.js',
  '/scripts/v397/poekhali-utils.js',
  '/scripts/v397/poekhali-map-parser.js',
  '/scripts/v397/poekhali-warnings.js',
  '/scripts/v397/poekhali-backup.js',
  '/scripts/v397/poekhali-tracker.js',
  '/scripts/v397/auth.js',
  '/scripts/v397/render.js',
  '/scripts/v397/shift-form.js',
  '/scripts/v397/datetime-picker.js',
  '/scripts/v397/app-init.js',
  '/scripts/v397/sw-register.js',

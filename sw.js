...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v402/00-base.css',
  '/styles/v402/10-navigation-and-cards.css',
  '/styles/v402/10-shell-navigation.css',
  '/styles/v402/11-poekhali-entry.css',
  '/styles/v402/12-cards.css',
  '/styles/v402/13-dashboard-cards.css',
  '/styles/v402/14-stats-and-salary.css',
  '/styles/v402/15-settings-and-docs.css',
  '/styles/v402/16-overlays-and-actions.css',
  '/styles/v402/15-bottom-nav.css',
  '/styles/v402/16-press-feedback.css',
  '/styles/v402/20-form-and-stats.css',
  '/styles/v402/30-shifts-and-overlays.css',
  '/styles/v402/40-premium-refresh.css',
  '/styles/v402/50-design-refresh.css',
  '/styles/v402/50-theme-shell.css',
  '/styles/v402/51-shifts.css',
  '/styles/v402/52-poekhali.css',
  '/styles/v402/53-salary.css',
  '/styles/v402/54-docs.css',
  '/styles/v402/55-forms.css',
  '/styles/v402/56-overlays.css',
  '/styles/v402/56-profile.css',
  '/styles/v402/57-datetime-picker.css',
  ...
  '/scripts/v402/safe-area.js',
  '/scripts/v402/nav-debug.js',
  '/scripts/v402/utils/haptics.js',
  '/scripts/v402/press-feedback.js',
  '/scripts/v402/app-constants.js',
  '/scripts/v402/poekhali-station-names.js',
  '/scripts/v402/glass-select.js',
  '/scripts/v402/viewport.js',
  '/scripts/v402/time-utils.js',
  '/scripts/v402/docs-app.js',
  '/scripts/v402/telegram-sdk-loader.js',
  '/scripts/v402/app.js',
  '/scripts/v402/poekhali-utils.js',
  '/scripts/v402/poekhali-map-parser.js',
  '/scripts/v402/poekhali-warnings.js',
  '/scripts/v402/poekhali-backup.js',
  '/scripts/v402/poekhali-tracker.js',
  '/scripts/v402/auth.js',
  '/scripts/v402/render.js',
  '/scripts/v402/shift-form.js',
  '/scripts/v402/datetime-picker.js',
  '/scripts/v402/app-init.js',
  '/scripts/v402/sw-register.js',

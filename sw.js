...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v408/00-base.css',
  '/styles/v408/10-navigation-and-cards.css',
  '/styles/v408/10-shell-navigation.css',
  '/styles/v408/11-poekhali-entry.css',
  '/styles/v408/12-cards.css',
  '/styles/v408/13-dashboard-cards.css',
  '/styles/v408/14-stats-and-salary.css',
  '/styles/v408/15-settings-and-docs.css',
  '/styles/v408/16-overlays-and-actions.css',
  '/styles/v408/15-bottom-nav.css',
  '/styles/v408/16-press-feedback.css',
  '/styles/v408/20-form-and-stats.css',
  '/styles/v408/30-shifts-and-overlays.css',
  '/styles/v408/40-premium-refresh.css',
  '/styles/v408/50-design-refresh.css',
  '/styles/v408/50-theme-shell.css',
  '/styles/v408/51-shifts.css',
  '/styles/v408/52-poekhali.css',
  '/styles/v408/53-salary.css',
  '/styles/v408/54-docs.css',
  '/styles/v408/55-forms.css',
  '/styles/v408/56-overlays.css',
  '/styles/v408/56-profile.css',
  '/styles/v408/57-datetime-picker.css',
  ...
  '/scripts/v408/safe-area.js',
  '/scripts/v408/nav-debug.js',
  '/scripts/v408/utils/haptics.js',
  '/scripts/v408/press-feedback.js',
  '/scripts/v408/app-constants.js',
  '/scripts/v408/poekhali-station-names.js',
  '/scripts/v408/glass-select.js',
  '/scripts/v408/viewport.js',
  '/scripts/v408/time-utils.js',
  '/scripts/v408/docs-app.js',
  '/scripts/v408/telegram-sdk-loader.js',
  '/scripts/v408/app.js',
  '/scripts/v408/poekhali-utils.js',
  '/scripts/v408/poekhali-map-parser.js',
  '/scripts/v408/poekhali-warnings.js',
  '/scripts/v408/poekhali-backup.js',
  '/scripts/v408/poekhali-tracker.js',
  '/scripts/v408/auth.js',
  '/scripts/v408/render.js',
  '/scripts/v408/shift-form.js',
  '/scripts/v408/datetime-picker.js',
  '/scripts/v408/app-init.js',
  '/scripts/v408/sw-register.js',

...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v416/00-base.css',
  '/styles/v416/10-navigation-and-cards.css',
  '/styles/v416/10-shell-navigation.css',
  '/styles/v416/11-poekhali-entry.css',
  '/styles/v416/12-cards.css',
  '/styles/v416/13-dashboard-cards.css',
  '/styles/v416/14-stats-and-salary.css',
  '/styles/v416/15-settings-and-docs.css',
  '/styles/v416/16-overlays-and-actions.css',
  '/styles/v416/15-bottom-nav.css',
  '/styles/v416/16-press-feedback.css',
  '/styles/v416/20-form-and-stats.css',
  '/styles/v416/30-shifts-and-overlays.css',
  '/styles/v416/40-premium-refresh.css',
  '/styles/v416/50-design-refresh.css',
  '/styles/v416/50-theme-shell.css',
  '/styles/v416/51-shifts.css',
  '/styles/v416/52-poekhali.css',
  '/styles/v416/53-salary.css',
  '/styles/v416/54-docs.css',
  '/styles/v416/55-forms.css',
  '/styles/v416/56-overlays.css',
  '/styles/v416/56-profile.css',
  '/styles/v416/57-datetime-picker.css',
  '/styles/v416/58-vu45.css',
  ...
  '/scripts/v416/safe-area.js',
  '/scripts/v416/nav-debug.js',
  '/scripts/v416/utils/haptics.js',
  '/scripts/v416/press-feedback.js',
  '/scripts/v416/app-constants.js',
  '/scripts/v416/locomotive-usage.js',
  '/scripts/v416/poekhali-station-names.js',
  '/scripts/v416/glass-select.js',
  '/scripts/v416/viewport.js',
  '/scripts/v416/time-utils.js',
  '/scripts/v416/docs-app.js',
  '/scripts/v416/telegram-sdk-loader.js',
  '/scripts/v416/app.js',
  '/scripts/v416/poekhali-utils.js',
  '/scripts/v416/poekhali-map-parser.js',
  '/scripts/v416/poekhali-warnings.js',
  '/scripts/v416/poekhali-backup.js',
  '/scripts/v416/poekhali-tracker.js',
  '/scripts/v416/auth.js',
  '/scripts/v416/render.js',
  '/scripts/v416/shift-form.js',
  '/scripts/v416/datetime-picker.js',
  '/scripts/v416/vu45-calculator.js',
  '/scripts/v416/vu45-ui.js',
  '/scripts/v416/app-init.js',
  '/scripts/v416/sw-register.js',
  '/sw-bootstrap-v416.js'
];

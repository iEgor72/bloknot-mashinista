...
const INSTALL_SHELL_URLS = [
  '/',
  '/index.html',
  '/styles/v400/00-base.css',
  '/styles/v400/10-navigation-and-cards.css',
  '/styles/v400/10-shell-navigation.css',
  '/styles/v400/11-poekhali-entry.css',
  '/styles/v400/12-cards.css',
  '/styles/v400/13-dashboard-cards.css',
  '/styles/v400/14-stats-and-salary.css',
  '/styles/v400/15-settings-and-docs.css',
  '/styles/v400/16-overlays-and-actions.css',
  '/styles/v400/15-bottom-nav.css',
  '/styles/v400/16-press-feedback.css',
  '/styles/v400/20-form-and-stats.css',
  '/styles/v400/30-shifts-and-overlays.css',
  '/styles/v400/40-premium-refresh.css',
  '/styles/v400/50-design-refresh.css',
  '/styles/v400/50-theme-shell.css',
  '/styles/v400/51-shifts.css',
  '/styles/v400/52-poekhali.css',
  '/styles/v400/53-salary.css',
  '/styles/v400/54-docs.css',
  '/styles/v400/55-forms.css',
  '/styles/v400/56-overlays.css',
  '/styles/v400/56-profile.css',
  '/styles/v400/57-datetime-picker.css',
  ...
  '/scripts/v400/safe-area.js',
  '/scripts/v400/nav-debug.js',
  '/scripts/v400/utils/haptics.js',
  '/scripts/v400/press-feedback.js',
  '/scripts/v400/app-constants.js',
  '/scripts/v400/glass-select.js',
  '/scripts/v400/viewport.js',
  '/scripts/v400/time-utils.js',
  '/scripts/v400/docs-app.js',
  '/scripts/v400/telegram-sdk-loader.js',
  '/scripts/v400/app.js',
  '/scripts/v400/poekhali-utils.js',
  '/scripts/v400/poekhali-map-parser.js',
  '/scripts/v400/poekhali-warnings.js',
  '/scripts/v400/poekhali-backup.js',
  '/scripts/v400/poekhali-tracker.js',
  '/scripts/v400/auth.js',
  '/scripts/v400/render.js',
  '/scripts/v400/shift-form.js',
  '/scripts/v400/datetime-picker.js',
  '/scripts/v400/app-init.js',
  '/scripts/v400/sw-register.js',
